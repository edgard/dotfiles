...
EOF
    ...
    echo "  sudo restic snapshots                          # List all snapshots"
    echo "  sudo restic snapshots --host $RESTIC_HOSTNAME  # List snapshots for this host"
    echo "  sudo restic restore latest --target /tmp/restore  # Restore latest snapshot"
