...
if_os linux && alias update="sudo apt-get update && sudo apt-get dist-upgrade; apm update; sudo ~/Documents/Apps/hardcode-fixer/fix.sh; rm -f ~/.local/share/applications/telegramdesktop.desktop"
