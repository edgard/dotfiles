...
gsettings set org.gnome.shell favorite-apps "['org.gnome.Nautilus.desktop', 'gnome-terminal.desktop', 'code.desktop', 'spotify.desktop', 'org.gnome.Contacts.desktop', 'org.gnome.Calendar.desktop', 'chrome-hmjkmjkepdijhoojdojkdfohbdgmmhki-Default.desktop', 'geary.desktop', 'telegram.desktop', 'google-chrome.desktop']"
