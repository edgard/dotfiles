---
name: commit
description: Create local git commit with conventional commit format. Use when user asks to commit changes or create a commit.
---
...
## Priorities
1. **Safety**: No destructive ops (reset, force-push) unless requested
2. **Style**: Terse; ASCII-only; no emojis; repo-local templates preferred
3. **Workflow**: Minimal diffs; no reformatting; follow existing patterns
4. **Minimalism**: No over-engineering; no unnecessary abstractions
